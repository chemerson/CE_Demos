...
public class SmileDirect {
	...
	private static final String BATCH_NAME = "SmileDirect Demo 1 Layout";
	private static final String BATCH_ID = null;  //optional or null, keep all tests in the same batch
	private static final String APP_NAME = "Shop SmileDirect";


	@Test(priority = 1, alwaysRun = true, enabled = true)
	public void CheckURLs_1() {
		Integer i=0;
		String testName = "Shop SmileDirect Web";
		long before;
