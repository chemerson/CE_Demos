...
public class VcsUtils {
    ...
    private static final String VCS_URL_KEY = "https://gitlab.com/chemerson/CE_Demos.git";
    private static final String VCS_COMMIT_KEY = "db878088cc2d247127b482168ccf15dd769b31e1";
    ...
    public static CustomField[] createVcsFields(String sourceFileRootPath, String testClassName) {
        ...
        String repositoryUrl = VCS_URL_KEY;
