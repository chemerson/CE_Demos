...
public class PerfectoLabUtils {
     ...
     */
    public static void uploadMedia(String host, String user, String password, byte[] content, String repositoryKey) throws IOException {
        if (content != null) {
    ...
    public static void setExecutionIdCapability(DesiredCapabilities capabilities, String host) throws IOException {
        ...
        if (intellijHost == null || (intellijHost.contains(host))) {
